...
import "./OrderConfirm.css"; // Custom CSS for animations
...
const OrderSuccess = () => (
  <div className="p-4 bg-light rounded shadow-sm hover-effect box mx-4">
...
const OrderDetails = () => (
  <div className="mt-4 p-4 bg-light rounded shadow-sm hover-effect box mx-4">
...
const ActionButtons = () => {
  ...
  return (
    <div className="mt-4 p-4 bg-light rounded shadow-sm hover-effect box d-flex gap-3 mx-4">
      <button
        className="btn btn-success hover-button"
